...
//=============================================================================
  ...
  document.getElementById("x-slide").oninput = function() {lightX = this.value;}
  document.getElementById("y-slide").oninput = function() {lightY = this.value;}
  document.getElementById("z-slide").oninput = function() {lightZ = this.value;}
  document.getElementById("ambr").oninput = function() {ambr = this.value;}
  document.getElementById("ambg").oninput = function() {ambg = this.value;}
  document.getElementById("ambb").oninput = function() {ambb = this.value;}
  document.getElementById("diffuser").oninput = function() {diffuser = this.value;}
  document.getElementById("diffuseg").oninput = function() {diffuseg = this.value;}
  document.getElementById("diffuseb").oninput = function() {diffuseb = this.value;}
  document.getElementById("specr").oninput = function() {specr = this.value;}
  document.getElementById("specg").oninput = function() {specg = this.value;}
  document.getElementById("specb").oninput = function() {specb = this.value;}
